...
const $$NpsTrimestral = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "NPS Trimestral - Sancor Team Eve garay" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Container", $$Container, {}, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "DarkMetricsDashboard", null, { "client:only": "react", "client:component-hydration": "only", "client:component-path": "/Users/macbookpro/Desktop/sancor-eve-garay/src/components/DarkMetricsDashboard", "client:component-export": "default" })} ` })} ` })}`;
}, "/Users/macbookpro/Desktop/sancor-eve-garay/src/pages/nps-trimestral.astro", void 0);

const $$file = "/Users/macbookpro/Desktop/sancor-eve-garay/src/pages/nps-trimestral.astro";
const $$url = "/nps-trimestral";

export { $$NpsTrimestral as default, $$file as file, $$url as url };
