/* empty css                                   */
import { k as createComponent, l as renderTemplate, o as renderHead, m as renderComponent } from './astro/server_D8vA9utB.mjs';
import 'kleur/colors';
import 'html-escaper';
import { $ as $$Image } from './_astro_assets_DpNQ9GEz.mjs';
...
const imagenDoctor = new Proxy({"src":"/_astro/doctor.DacvNxJW.jpg","width":1920,"height":1920,"format":"jpg"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/macbookpro/Desktop/equipo-2/public/doctor.jpg";
							}
...
}, "/Users/macbookpro/Desktop/equipo-2/src/components/NotFound.astro", void 0);

const $$Promotores = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "NotFound", $$NotFound, {})}`;
}, "/Users/macbookpro/Desktop/equipo-2/src/pages/promotores.astro", void 0);

const $$file = "/Users/macbookpro/Desktop/equipo-2/src/pages/promotores.astro";
const $$url = "/promotores";

export { $$Promotores as default, $$file as file, $$url as url };
